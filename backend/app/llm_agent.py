    ...
    async def suggest_commands(
        ...
        if is_llm_mode:
            system = (
                ...
                "CRITICAL RULES:\n"
                "- If user mentions a person/assignee for a task, ALWAYS use 'с исполнителем {person}' in the command\n"
                "- If user mentions duration (days), ALWAYS use 'на {N} дней' in the command\n"
                "- Combine both when both are mentioned\n"
